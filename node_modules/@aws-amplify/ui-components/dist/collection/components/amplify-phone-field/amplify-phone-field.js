...
export class AmplifyPhoneField {
    ...
    render() {
        return (h("div", null,
            h("amplify-form-field", { label: I18n.get(this.label), hint: this.hint, required: this.required },
                h("div", { class: "phone-field", slot: "input" },
                    ...
                    h("amplify-input", { fieldId: this.fieldId, type: "tel", handleInputChange: this.handleInputChange, placeholder: I18n.get(this.placeholder), name: this.fieldId, value: this.value, inputProps: this.inputProps, disabled: this.disabled })))));
    }
